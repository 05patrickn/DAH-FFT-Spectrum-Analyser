...
# List of file paths
file_paths = [
    "C:/Users/05pat/OneDrive/Escritorio/DAH Project Final/Results/2Khz_data1.txt",
    "C:/Users/05pat/OneDrive/Escritorio/DAH Project Final/Results/8Khz_data1.txt",
    "C:/Users/05pat/OneDrive/Escritorio/DAH Project Final/Results/32Khz_data1.txt",
    "C:/Users/05pat/OneDrive/Escritorio/DAH Project Final/Results/50Khz_data1.txt"
]
...
for i, file_path in enumerate(file_paths):
    ...
    # Calculate time values based on the length of the data and sampling frequency
    time_values = np.arange(0, len(data)) * (1 / sampling_frequency)
    ...
    axs[i, 0].set_title(f'Experimental Sinusoidal Waveform - {frequencies[i]/1000} KHz')
